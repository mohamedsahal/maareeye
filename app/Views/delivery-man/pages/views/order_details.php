                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <label class="fw-bolder" for="select_all_products">Select All</label>
                                </div>
                                <?php if (!empty($items)) ?>
                                <div class="row">
                                        ...
                                        <div class="card  card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                            ...
                                            <div class="col-md mb-2">
                                                <div data-crop-image="100">
                                                    <img alt="image" src="<?= $item['image'] ?>" class="order-detail-image">
                                                </div>
                                            </div>
                                            <div class="col-md">
                                            ...
                                            <div class="form-group col-md">
                                                <select name="status" id="status" class="form-control status_update">
                                                    <option value="<?= !empty($item['status']) ? $item['status'] : "" ?>"
                                                        selected><?= !empty($item['status_name']) ? $item['status_name'] : "" ?>
                                                    </option>
                                                    <?php if (!empty($status))
                                ...
                                <div class="row">
                                    <?php foreach ($services as $service) { ?>
                                        <div class="card  card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                            ...
                                            <div class="col-md mb-2">
                                                <div data-crop-image="100">
                                                    <img alt="image" src="<?= $service['image'] ?>" class="order-detail-image">
                                                </div>
                                            </div>
                                            <div class="col-md">
                                                <p class="order-detail-p"><strong><?= labels('service_name', 'Service Name') ?>:
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="order-detail-p"><strong><?= labels('payment_method', 'Payment Method') ?>:
                            </strong><span><?= !empty($order['payment_method']) ? $order['payment_method'] : "" ?></span>
                        </p>
                ...
                <div class="card">
                    <div class="card">
                        <div class="section-title ml-3"><?= labels('payment_summary', "Payment Summary") ?>
                            <?php if (!empty($order) && ($order['payment_method'] != "wallet") && $transaction_permission == "1") { ?>
                        ...
                        <?php if (isset($order) && !empty($order)) { ?>
                            <div class="col-md">
                                <table class="table table-bordered table-hover " id="orders_transactions_table"
                                    ...
                                    data-url="<?= base_url('delivery_boy/transactions/customer_transaction_table') . "/" . $order['id'] . "/" . $order['customer_id']; ?>"
    ...
    <div class="modal-dialog modal-m">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action='<?= base_url('delivery_boy/transactions/save_payment') ?>'
