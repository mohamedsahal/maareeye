        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-submit-event" method="post"
                            action='<?= base_url('delivery_boy/transactions/save_payment') ?>'>
                            ...
                            <div class="form-group">
                                ...
                                <select name="created_by" id="created_by" class="form-control">
                                    <option value="<?= $delivery_boy_id ?>" selected><?= labels('you', 'You') ?>
                                    </option>
                                </select>
                            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover" id="customers_table" data-auto-refresh="true"
                            ...
                            data-url="<?= base_url('delivery_boy/transactions/customers_table'); ?>"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <table class="table table-bordered table-hover" data-show-export="true"
                                ...
                                data-page-list="[5, 10, 25, 50, 100, 200, All]"
                                data-url="<?= base_url('delivery_boy/transactions/transactions_table'); ?>"
                                data-side-pagination="server" data-pagination="true" data-search="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="opening_balance" data-sortable="true" data-visible="true">
                                            <?= labels('opening_balance', 'Opening Balance') ?>
                                        </th>
                                        <th data-field="closing_balance" data-sortable="true" data-visible="true">
