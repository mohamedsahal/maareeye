                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/settings/save_settings') ?>" class="form-submit-event"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md">
                                        <textarea class="texteditor" rows=30 id="refund_policy"
                                            name="refund_policy"><?= !empty($refund_policy) && !empty($refund_policy['refund_policy']) ? $refund_policy['refund_policy'] : " Refund Policy" ?></textarea>
