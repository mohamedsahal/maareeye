                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="align-items-center col-md-3 d-flex gap-3 justify-content-start">
                                <button class="btn btn-primary d-block" id="transaction_filter_btn"
                        ...
                        <table class="table table-bordered table-hover" data-show-export="true"
                            ...
                            data-export-options='{"fileName": "transactions-list"}' id="admin_transactions_table"
                            data-show-refresh="true" data-auto-refresh="true" data-show-columns="true"
                            data-show-toggle="true" data-toggle="table" data-search-highlight="true"
                            data-server-sort="true" data-page-list="[5, 10, 25, 50, 100, 200, All]"
                            data-url="<?= base_url('admin/transactions/transactions_table'); ?>"
