        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="btn-group mr-2 no-shadow">
                    <a href="#" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#today_stat"
                        data-toggle="tooltip" data-bs-placement="bottom" title=""
                        data-bs-original-title=" ToDay Statastices">
                ...
                <div class="section-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="row m-1">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select2 product_category form-control" id="product_warehouse"
                                            name="warehouse_id" onchange="fetch_products(this)">
                        ...
                        <div class="col-md-4">
                            ...
                            <section>
                                <form action="<?= base_url('vendor/orders/save_order') ?>" id="place_order_form"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <button class="btn btn-clear_cart btn-xs text-danger" type="reset"
                                                    id="clear_cart_btn"><i
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-end mt-4">
                                                <div class="col-md-12 text-left px-0">
                                                    ...
                                                    <input type="number" class="final_total form-control No-negative"
                                                        id="discount" value="" placeholder="0.00" name="discount">

                                                    <div class="billing-detail-table mt-4">
                                                        <table class="table table-borderless w-100">
                                                            <tr>
                                                                <td class="cart-total ps-0">
                                                                    <p class="h6"><?= labels('subtotal', 'Subtotal') ?>
                                                                    </p>
                                                                </td>
                                                                <td class="pe-0">
                                                            ...
                                                            <tr>
                                                                <td class="cart-total ps-0">
                                                                    <p class="h6"><?= labels('discount', 'Discount') ?>
                                                                    </p>
                                                                </td>

                                                                <td class="pe-0">
                                                                    <p class="h6 text-right pe-0" id="cart_discount"
                                                        ...
                                                        <div class="align-items-center d-flex justify-content-between">
                                                            ...
                                                            <div class="pe-0">
                                                                <h6 class="cart-value text-right pe-0" id="final_total"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="custom-control custom-radio  type">
                                                        <input type="radio" id="wallet" name="payment_method[]"
                                                            value="wallet" class="custom-control-input payment_method">
                                                    ...
                                                    <div class="custom-control custom-radio bar_code ">
                                                        <input type="radio" id="bar_code" name="payment_method[]"
                                                            value="bar_code"
                                                            class="custom-control-input payment_method">
                                                    ...
                                                    <div class="custom-control custom-radio net_banking ">
                                                        <input type="radio" id="net_banking" name="payment_method[]"
                                                            value="net_banking"
                                                            class="custom-control-input payment_method">
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-control custom-radio other">
                                                        <input type="radio" id="other" name="payment_method[]"
                                                            value="other" class="custom-control-input payment_method">
                                                ...
                                                <select class="form-control" id="status" name="status">
                                                    ...
                                                    <?php if (!empty($status) && isset($status)) {
                                                        foreach ($status as $val) { ?>
                                                            <option value="<?= $val['id'] ?>"><?= ucwords($val['status']) ?>
                                                            </option>
                                                        <?php }
                                                    } ?>
                                                </select>
                                            ...
                                            <div class="text-center mt-4">
                                                ...
                                                <button type="button" class="btn btn-sm btn-dark mb-2 d-none"
                                                    id="pos_quick_invoice" onclick="printInvoice()" data-id="">Print
                                                    last
                                                    order Invoce</button>
                                            </div>
                                        </div>
            ...
            <div class="tab-pane fade" id="Services" role="tabpanel" aria-labelledby="services-tab">
                <div class="section-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <section>
                                <form action="<?= base_url('vendor/orders/save_order') ?>" id="place_service_order_form"
                                    accept-charset="utf-8" method="POST">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="align-items-end d-flex justify-content-between mt-2">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <button class="btn btn-xs btn-clear_cart text-danger" type="reset"
                                                    id="clear_cart_btn"><i
                                                        class="fa-trash-alt fas text-danger mr-1"></i><?= labels('clear_cart', 'Clear Cart') ?></button>
                                            </div>
                                            <div class="services">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="amount_paid d-none mt-3">
                                                        ...
                                                        <input type="number" class="form-control" id="amount_paid"
                                                            value="" placeholder="0.00" name="amount_paid" min="0.00">
                                                    </div>
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <div class="custom-control custom-radio type">
                                                        <input type="radio" id="wallet_service"
                                                            ...
                                                            class="custom-control-input payment_method_service">
                                                        <label class="custom-control-label" for="wallet_service">
                                                            <?= labels('wallet', 'Wallet') ?></label><span
                                                            class="float-right"><small><label
                                                    ...
                                                    <div class="custom-control custom-radio card_payment ">
                                                        <input type="radio" id="card_payment_service"
                                                            ...
                                                            class="custom-control-input payment_method_service">
                                                        <label class="custom-control-label" for="card_payment_service">
                                                    ...
                                                    <div class="custom-control custom-radio bar_code ">
                                                        <input type="radio" id="bar_code_service"
                                                            ...
                                                            class="custom-control-input payment_method_service">
                                                        <label class="custom-control-label" for="bar_code_service">
                                                            <?= labels('Bar_code_qR_code_scan', 'Bar Code / QR Code Scan') ?></label>
                                                    </div>
                                                    ...
                                                    <div class="custom-control custom-radio net_banking ">
                                                        <input type="radio" id="net_banking_service"
                                                            ...
                                                            class="custom-control-input payment_method_service">
                                                        <label class="custom-control-label" for="net_banking_service">
                                                            <?= labels('net_banking', 'Net Banking') ?></label>
                                                    </div>

                                                    <div class="custom-control custom-radio online_payment ">
                                                        <input type="radio" id="online_payment_service"
                                                            name="payment_method_service[]" value="online_payment"
                                                            class="custom-control-input payment_method_service">
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="order_type" id="order_type_service"
                                                        value="service">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <span id="today_payments_remaining" data-currency="<?= $currency ?>">
                                            </span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <b>Total Purchase </b> : <span id="today_purchase"
                                                data-currency="<?= $currency ?>"></span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <b> Total Expenses </b> : <span id="today_expanse"
                                                data-currency="<?= $currency ?>"></span>
                                        </div>
                                        <div>
                                            <b> Total Profit </b> : <span id="today_profit"
                                                data-currency="<?= $currency ?>"></span>
                                        </div>
                                    </div>
