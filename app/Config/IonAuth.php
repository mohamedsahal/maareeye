...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
	public $siteTitle                = 'maareeye.taskhub.company';       // Site Title, example.com
	public $adminEmail               = 'infinitietechnologies04@gmail.com'; // Admin Email, admin@example.com
	public $defaultGroup             = 'vendors';           // Default group, use name
	public $adminGroup               = 'admin';             // Default administrators group, use name
	public $vendorGroup              = 'vendors';             // Default administrators group, use name
	public $deliveryBoyGroup         = 'delivery_boys';             // Default administrators group, use name
	public $teamMembersGroup            = 'team_members'; 
	public $customerGroup            = 'customers';             // Default administrators group, use name
	public $suppliersGroup            = 'suppliers';             // Default administrators group, use name
	public $identity                 = 'mobile';             /* You can use any unique column in your table as identity column.
